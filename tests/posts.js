...
test('update urls for ghost - remove path and ext for html url', t => {
  t.is(processHtml('<a href=\"https://blog.odd-e.com/yilv/2021/07/limits-to-one-product-backlog---3.html\"></a>'),
    '<a href=\"https://localhost:8080/limits-to-one-product-backlog---3\"></a>');
})

test('update urls for ghost - dot in the image name', t => {
  t.is(processHtml('<p><img src="https://blog.odd-e.com/yilv/assets_c/2023/10/a%20vs.%20b.jpg" alt="1.jpg" /></p>'),
    '<p><img src="https://localhost:8080/content/images/a-vs-b.jpg" alt="1.jpg" /></p>')
